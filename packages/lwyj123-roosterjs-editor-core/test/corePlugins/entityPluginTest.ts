import * as commitEntity from 'lwyj123-roosterjs-editor-dom/lib/entity/commitEntity';
...
import { createDefaultHtmlSanitizerOptions } from 'lwyj123-roosterjs-editor-dom';
import {
    ChangeSource,
    EntityClasses,
    EntityOperation,
