import * as addRangeToSelection from 'lwyj123-roosterjs-editor-dom/lib/selection/addRangeToSelection';
import * as extractClipboardEvent from 'lwyj123-roosterjs-editor-dom/lib/clipboard/extractClipboardEvent';
import CopyPastePlugin from '../../lib/corePlugins/CopyPastePlugin';
import { Position } from 'lwyj123-roosterjs-editor-dom';
import {
    ClipboardData,
