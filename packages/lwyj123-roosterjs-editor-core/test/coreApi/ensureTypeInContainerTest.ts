import * as createRange from 'lwyj123-roosterjs-editor-dom/lib/selection/createRange';
import createEditorCore from './createMockEditorCore';
import { DefaultFormat, NodePosition, PositionType } from 'lwyj123-roosterjs-editor-types';
