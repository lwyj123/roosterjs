import { contains, createRange } from 'lwyj123-roosterjs-editor-dom';
import { EditorCore, GetSelectionRange } from 'lwyj123-roosterjs-editor-types';
...
export const getSelectionRange: GetSelectionRange = (
    ...
    if (core.lifecycle.shadowEditFragment) {
        ...
        if (!tryGetFromCache || core.api.hasFocus(core)) {
            let selection = core.host.getSelection();
