import { EntityState } from 'lwyj123-roosterjs-editor-types';
import { getSelectionPath, Position } from 'lwyj123-roosterjs-editor-dom';
import {
    AddUndoSnapshot,
    ChangeSource,
    ContentChangedData,
...
import type { CompatibleChangeSource } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
