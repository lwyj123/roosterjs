import { ColorKeyAndValue, DarkColorHandler, ModeIndependentColor } from 'lwyj123-roosterjs-editor-types';
import { getObjectKeys, parseColor } from 'lwyj123-roosterjs-editor-dom';
