...
import { createElement, normalizeRect, safeInstanceOf } from 'lwyj123-roosterjs-editor-dom';
import { CreateElementData, IEditor, Rect } from 'lwyj123-roosterjs-editor-types';
