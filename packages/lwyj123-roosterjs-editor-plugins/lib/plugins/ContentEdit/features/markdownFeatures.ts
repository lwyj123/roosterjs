import { cacheGetEventData, createRange, Position, wrap } from 'lwyj123-roosterjs-editor-dom';
import type { CompatibleKeys } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
import {
    BuildInEditFeature,
    ChangeSource,
    IEditor,
