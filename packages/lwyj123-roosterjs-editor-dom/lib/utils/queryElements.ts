...
import { DocumentPosition, NodeType, QueryScope } from 'lwyj123-roosterjs-editor-types';
import type { CompatibleQueryScope } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
