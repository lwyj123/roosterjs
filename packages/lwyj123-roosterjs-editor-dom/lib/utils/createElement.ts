...
import { CreateElementData, EditorHost, KnownCreateElementDataIndex } from 'lwyj123-roosterjs-editor-types';
import type { CompatibleKnownCreateElementDataIndex } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
