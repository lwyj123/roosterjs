...
import { QueryScope, Region, RegionType } from 'lwyj123-roosterjs-editor-types';
import type { CompatibleRegionType } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
