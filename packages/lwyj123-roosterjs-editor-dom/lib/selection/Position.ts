...
import { NodePosition, NodeType, PositionType } from 'lwyj123-roosterjs-editor-types';
import type { CompatiblePositionType } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
