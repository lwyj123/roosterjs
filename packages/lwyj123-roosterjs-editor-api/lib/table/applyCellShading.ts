...
import { IEditor, ModeIndependentColor } from 'lwyj123-roosterjs-editor-types';
import { safeInstanceOf, saveTableCellMetadata, setColor } from 'lwyj123-roosterjs-editor-dom';
