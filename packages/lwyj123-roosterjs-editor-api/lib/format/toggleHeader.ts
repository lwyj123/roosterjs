...
import { DocumentCommand, IEditor, QueryScope } from 'lwyj123-roosterjs-editor-types';
import { HtmlSanitizer, moveChildNodes } from 'lwyj123-roosterjs-editor-dom';
    ...
    formatUndoSnapshot(
        ...
        () => {
            ...
            if (level > 0) {
                ...
                editor
                    .getEditorHost()
                    .execCommand(DocumentCommand.FormatBlock, false, `<H${level}>`);
            }
        },
        'toggleHeader'
    );
