...
import { BulletListType, IEditor, ListType } from 'lwyj123-roosterjs-editor-types';
import type { CompatibleBulletListType } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
