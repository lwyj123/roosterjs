...
import { getObjectKeys, PendableFormatCommandMap, PendableFormatNames } from 'lwyj123-roosterjs-editor-dom';
import {
    DocumentCommand,
    IEditor,
    PluginEventType,
...
import type { CompatibleDocumentCommand } from 'lwyj123-roosterjs-editor-types/lib/compatibleTypes';
...
export default function execCommand(
    ...
    let formatter = () => editor.getEditorHost().execCommand(command, false, undefined);
